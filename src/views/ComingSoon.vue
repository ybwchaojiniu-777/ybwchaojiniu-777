    ...
    <div class="movie_body">
        ...
        <ul>
            <li>
                ...
                <div class="info_list">
                    <h2>佐罗喝麦克斯</h2>
                    <p><span class="grade">46465</span>人想看</p>
                    <p>主演：格兰特·鲍尔，艾米·斯马特，博伊德·肯斯特纳
                    </p>
                    <p>未来30天内上映</p>
                </div>
                <div class="btn_mall">
            ...
            <li>
                ...
                <div class="info_list">
                    <h2>废材特工</h2>
                    <p><span class="grade">64645</span>人想看</p>
                    <p>主演：艾西·艾森伯格，克里斯丁·斯图尔特，约翰·雷吉扎莫
                    </p>
                    <p>未来30天内上映</p>
                </div>
                <div class="btn_mall">
            ...
            <li>
                ...
                <div class="info_list">
                    <h2>凤凰城遗忘录</h2>
                    <p><span class="grade">42465</span>人想看</p>
                    <p>主演：Clint Jordan
                    </p>
                    <p>未来30天内上映</p>
                </div>
            ...
            <li>
                ...
                <div class="info_list">
                    <h2>新灰姑娘</h2>
                    <p><span class="grade">46465</span>人想看</p>
                    <p>主演：Cassandra Morris，Kristen Day
                    </p>
                    <p>未来30天内上映</p>
                </div>
                <div class="btn_mall">
            ...
            <li>
                ...
                <div class="info_list">
                    <h2>鲨卷风4：四度觉醒</h2>
                    <p><span class="grade">38465</span>人想看</p>
                    <p>主演：塔拉·雷德，Ian Ziering，Masiela Lusha
                    </p>
                    <p>未来30天内上映</p>
                </div>
                <div class="btn_mall">
            ...
            <li>
                ...
                <div class="info_list">
                    <h2>全境警戒</h2>
                    <p><span class="grade">46465</span>人想看</p>
                    <p>主演：戴夫·巴蒂斯塔，布兰特妮·斯诺，Angelic Zambrana
                    </p>
                    <p>未来30天内上映</p>
                </div>
                <div class="btn_mall">
